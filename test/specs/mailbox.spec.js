describe('Verify main functionality of the mailbox', function() {
  ...
  it('should login to the mailbox',async function() {
    ...
    var loginButton = await $('.//*[@id="ybar-inner-wrap"]/div[3]/div/div[3]/div[1]/div/a');
  ...
  it('should verify that the login was successfull',async function() {
    var labelOfProfile = await $('#ybarAccountMenuOpener');
  ...
  it('should verify the draft content',async function() {
    var draftEmailList = await $('li a[aria-label*="From: test1234512345@yopmail.com"]');
  ...
  var logoutButton = await $('//*[@id="profile-signout-link"]');
